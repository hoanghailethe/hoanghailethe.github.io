...
public class PeopleController {
  ...
  @GetMapping("5citistopsalary3")
  public ResponseEntity<List<Map.Entry<String,Double>>> fiveCitiesHasTopAverageSalary3() {
    return ResponseEntity.ok().body(personRepo.fiveCitiesHasTopAverageSalary3());
  }
  ...
  public Map<String, Double> averageAgePerCity() {
    return personRepo.averageAgePerCity();
  }

  //2.11 Tuổi cao nhất ở mỗi thành phố
  @GetMapping("maxagepercity2")
  public ResponseEntity<List<Map.Entry<String, Integer>>> maxAgePerCity2() {
    return ResponseEntity.ok().body(personRepo.maxAgePerCity2());
  }
  ...
  //2.13 số lượng lập trình viên cao nhất theo TP
  @GetMapping("devNumsEachCity")
  public ResponseEntity<List<Map.Entry<String,Long>>> devNumsEachCity() {
    return ResponseEntity.ok().body(personRepo.TestcityHasMaxNumberOfDeveloper());
  }
