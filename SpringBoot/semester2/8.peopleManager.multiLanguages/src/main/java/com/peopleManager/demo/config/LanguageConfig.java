...
public class LanguageConfig implements WebMvcConfigurer {
    //other way to bind message: https://www.baeldung.com/spring-custom-validation-message-source
    @Bean
    ...
    //https://stackoverflow.com/questions/45692179/spring-boot-validation-message-is-not-being-resolved/45692687
